...
public class Person {
     ...
     */
    public Person(Name name, Phone phone, Email email, Height height,
                  JerseyNumber jerseyNumber, Set<Tag> tags, Weight weight) {
    ...
    /**
     * Returns true if both persons have the same jersey number.
     * This also defines a weaker notion of equality between
     * two players.
     */
    public boolean isSameJerseyNumber(Person otherPerson) {
        if (otherPerson == this) {
            return true;
        }
        return otherPerson != null
